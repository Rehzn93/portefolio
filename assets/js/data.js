...
const DATA = {
  ...
  profil: {
    ...
    accroche: "De la résolution de problèmes à l'intelligence artificielle appliquée à la santé.",
  ...
  accueil: {
    ...
    lead: "Étudiant en 2ᵉ année de BUT Informatique, en recherche d'une alternance. Ce qui me caractérise : la rigueur et la curiosité. Si je me suis orienté vers l'informatique, ce n'est pas par hasard — c'est pour relier la logique à des domaines concrets comme l'IA et la santé. Ce portfolio retrace mon parcours, mes compétences et l'évolution de mes SAÉ, du BUT1 au BUT2.",
    stats: [
    ...
    filConducteur: "Mon fil conducteur : mettre la technique au service du concret et de l'humain — relier la logique de l'informatique à des domaines qui ont du sens pour moi, comme l'IA et la santé.",
  },

  /* ------------------------------------------------------------- PARCOURS */
  parcours: {
    presentation: `Actuellement étudiant en 2ᵉ année de BUT Informatique à l'IUT de Villetaneuse, j'ai depuis l'enfance le réflexe de chercher à comprendre comment les choses fonctionnent et de m'attaquer aux problèmes plutôt que de les contourner. C'est ce goût pour la logique, cette curiosité et cette rigueur qui m'ont naturellement conduit vers cette orientation — un choix réfléchi, pas le fruit du hasard.

Mes centres d'intérêt majeurs sont l'Intelligence Artificielle et l'informatique appliquée à la santé. Ce qui m'attire dans l'IA, c'est sa capacité à apprendre, à s'adapter et à résoudre des problèmes complexes — la technologie de demain. Pour l'informatique médicale, c'est la possibilité d'améliorer concrètement la vie des gens : aide au diagnostic, suivi des patients, recherche. Le monde de la médecine m'a toujours attiré ; pouvoir combiner ces deux domaines est un véritable objectif.`,
    ...
    engagements: [
      { titre: "Bénévolat à la mosquée", texte: "À COMPLÉTER : ton rôle, la fréquence, ce que cela t'a appris (organisation, sens du collectif, responsabilité…)." },
      { titre: "Vie associative", texte: "À COMPLÉTER : nom de l'association, ton rôle, les compétences/soft skills développés." },
    ],

    // Évolution BUT1 → BUT2 (fil conducteur de progression)
    evolution: [
      { periode: "BUT1", titre: "Les fondations", texte: "Découverte de la programmation (Java, Python), des bases de données, de l'administration système et du travail en équipe. Premières SAÉ structurantes." },
      { periode: "BUT2", titre: "L'approfondissement & le stage", texte: "Des projets plus complexes et une vraie montée en autonomie, couronnés par un stage de 8 semaines à la DSI d'ICF Habitat (groupe SNCF) en administration système & réseau : cartographie du SI (projet Mercator), automatisation PowerShell, réseau, et découverte de l'IA d'entreprise." },
      { periode: "Cap", titre: "Vers l'alternance & l'ingénierie", texte: "Objectif : une alternance de qualité, puis une école d'ingénieur ou un master orienté IA / data science." },
    ],
  },
  ...
  competences: [
    {
      ...
      desc: "Concevoir et développer des applications en utilisant des langages comme Python ou Java, de la conception à l'implémentation.",
      detail: "Je suis capable de mener une activité de développement d'applications. J'ai réalisé en binôme un jeu d'échecs en Java dans un projet tutoré, ainsi que divers mini-jeux en JavaScript. Ces travaux m'ont permis de percevoir toutes les étapes d'un projet logiciel, de la conception à l'implémentation.",
    ...
    },
    {
      ...
      detail: "J'ai appris à administrer des systèmes : configurer un réseau local simple, manipuler les droits d'accès sous Linux, comprendre le fonctionnement des serveurs. Ces bases me permettent de mieux comprendre les environnements dans lesquels mes applications seront utilisées.",
    ...
    },
    {
      ...
      desc: "Modéliser et exploiter des bases de données relationnelles avec SQL.",
      detail: "Je sais gérer des données via la modélisation de bases relationnelles et l'utilisation de SQL. Sur un projet, j'ai conçu un schéma relationnel complet pour un réseau social fictif et écrit les requêtes associées.",
      niveauBut1: 50, niveauBut2: 76,
      pistesAmelioration: "Aller au-delà des schémas relationnels simples : optimisation et indexation des requêtes, procédures stockées, et découverte du NoSQL et de la donnée pour l'IA — l'un de mes objectifs.",
    ...
    },
    {
      ...
      detail: "J'ai été formé à la conduite de projet : analyse des besoins, planification, répartition des tâches, suivi d'avancement. J'ai découvert le rôle de chef de projet et des outils comme les diagrammes de Gantt et les tableaux de suivi, en intégrant l'importance d'objectifs clairs et mesurables.",
    ...
    },
    {
      ...
      detail: "La majorité des projets en IUT se font en binôme ou en petit groupe. J'ai compris l'intérêt de communiquer, d'écouter, de s'adapter et de tenir sa place. Cette capacité à collaborer est fondamentale dans les métiers de l'informatique, notamment dans la santé.",
      niveauBut1: 60, niveauBut2: 84,
      pistesAmelioration: "Renforcer ma maîtrise de Git en équipe (branches, revues de code, résolution de conflits) et prendre plus souvent un rôle moteur de coordination, au-delà de la simple exécution.",
      preuves: ["s3-01", "s2-06"],
    },
  ],
  ...
  technos: [
    // — Langages —
    { id: "python", nom: "Python", categorie: "Langages", niveau: 3,
      resume: "Scripts d'automatisation et d'importation de données, API back-end.",
    ...
    { id: "java", nom: "Java", categorie: "Langages", niveau: 2,
    ...
    { id: "javascript", nom: "JavaScript", categorie: "Langages", niveau: 2,
      resume: "Interactivité web et mini-jeux ; ce portfolio est en JavaScript pur.",
      experiences: [{ label: "Ce portfolio", href: "#/accueil" }, { label: "SAÉ S2.01", href: "#/sae/s2-01" }], preuves: [] },
    { id: "csharp", nom: "C#", categorie: "Langages", niveau: 1,
      resume: "Découverte du back-end du portail DSI (parcours Microsoft Learn).",
      experiences: [{ label: "Stage — équipe dev", href: "#/stage" }], preuves: [] },
    { id: "sql", nom: "SQL", categorie: "Langages", niveau: 2,
      resume: "Modélisation relationnelle et requêtes sur des bases de données.",
      experiences: [{ label: "SAÉ S1.04", href: "#/sae/s1-04" }], preuves: [] },
    { id: "powershell", nom: "PowerShell", categorie: "Langages", niveau: 2,
      resume: "Automatisation système : audit/nettoyage SPN, intégration à VTOM.",
    ...
    { id: "flask", nom: "Flask", categorie: "Web & frameworks", niveau: 2,
      resume: "Conception d'une API REST exposant des scripts Python.",
      experiences: [{ label: "Stage — Mercator", href: "#/stage" }], preuves: [] },
    { id: "angular", nom: "Angular", categorie: "Web & frameworks", niveau: 1,
      resume: "Lecture et compréhension d'un front-end professionnel.",
      experiences: [{ label: "Stage — portail DSI", href: "#/stage" }], preuves: [] },

    // — Systèmes & réseau —
    { id: "linux", nom: "Linux", categorie: "Systèmes & réseau", niveau: 2,
    ...
    { id: "reseau", nom: "Réseau & switching", categorie: "Systèmes & réseau", niveau: 2,
      resume: "Configuration de switches, boucles réseau et protocole Spanning Tree.",
      experiences: [{ label: "Stage — travaux réseau", href: "#/stage" }], preuves: [] },
    { id: "ad", nom: "Active Directory", categorie: "Systèmes & réseau", niveau: 2,
      resume: "Requêtes annuaire, gestion DNS/SPN, authentification Kerberos.",
      experiences: [{ label: "Stage — projet SPN", href: "#/stage" }], preuves: [] },
    { id: "virtu", nom: "Virtualisation", categorie: "Systèmes & réseau", niveau: 1,
      resume: "Machines virtuelles (VMware), sauvegardes (Veeam), supervision (Zabbix).",
      experiences: [{ label: "Stage", href: "#/stage" }], preuves: [] },

    // — Outils —
    { id: "git", nom: "Git", categorie: "Outils", niveau: 2,
      resume: "Versioning et collaboration sur des projets de groupe.",
      experiences: [{ label: "SAÉ S2.06", href: "#/sae/s2-06" }], preuves: [] },
    { id: "putty", nom: "PuTTY / SFTP", categorie: "Outils", niveau: 2,
    ...
    { id: "gantt", nom: "Gestion de projet", categorie: "Conception & design", niveau: 2,
      resume: "Planification, diagrammes de Gantt et tableaux de suivi.",
  ...
  saes: [
    ...
    /* ===== SAÉ PHARES (déjà détaillées depuis ton PDF BUT1) ===== */
    {
      ...
      resume: "Développement d'une application en Java à partir d'un cahier des charges fonctionnel et technique exigeant.",
      objectif: "Développer une application complète en Java en respectant un cahier des charges fonctionnel et technique annoncé comme complexe.",
    ...
    },
    {
      ...
      resume: "Première immersion profonde dans le travail collaboratif : organisation et répartition des tâches d'un projet de recherche d'alternance.",
      objectif: "Organiser et répartir les tâches d'un projet de recherche d'alternance, du choix des outils jusqu'au respect des délais de dépôt des livrables.",
    ...
    },
    {
      ...
      resume: "Installation et configuration d'un poste de développement sous Linux avec tous les outils nécessaires pour coder dans un cadre professionnel.",
      objectif: "Installer et configurer un poste de travail sous Linux, prêt pour le développement professionnel.",
      mission: "Mise en place d'un environnement stable et sécurisé : ligne de commande, permissions, paquets, personnalisation du terminal, machine virtuelle.",
      organisation: "Travail individuel, en autonomie, dès le premier semestre.",
      role: "Administration complète du poste, du système aux outils.",
      difficultes: "Je n'avais jamais utilisé de système Unix et mon expérience de l'installation logicielle était limitée. Un problème de dépendances bloquait une installation.",
      solution: "J'ai appris la ligne de commande, la gestion des permissions et des paquets. J'ai configuré une machine virtuelle et résolu seul le problème de dépendances — une réussite technique mais aussi symbolique de la confiance acquise.",
      competencesAcquises: [
      ...
      avant: "Aucune expérience d'Unix, installation logicielle limitée.",
      apres: "Capable d'installer et configurer en autonomie un environnement de développement Linux complet.",
    ...
    },
    {
      ...
      mission: "Structurer le projet avec des outils de gestion (Gantt, tableaux de suivi, tableaux collaboratifs) et se fixer des objectifs clairs et mesurables.",
      ...
      competencesAcquises: [
        ...
        "Diagrammes de Gantt et tableaux de suivi",
    ...
    { id: "s1-01", code: "SAÉ S1.01", important: false, titre: "Implémentation d'un besoin client",
      ...
      resume: "À COMPLÉTER : court résumé de la SAÉ.", todo: true, preuves: [] },
      ...
      resume: "À COMPLÉTER : court résumé de la SAÉ.", todo: true, preuves: [] },
    {
      ...
      resume: "Modélisation et création d'une base de données relationnelle (catastrophes climatiques), du modèle relationnel au script SQL et au peuplement depuis un fichier plat.",
      objectif: "Modéliser une base de données relationnelle, en comprendre le fonctionnement, écrire le script SQL de création des tables et la peupler à partir d'un fichier plat.",
      role: "Réalisée en autonomie : modélisation avec l'AGL SQL Power Architect, écriture du script SQL (des tables les plus indépendantes aux plus dépendantes : régions, pays, catastrophes climatiques) et peuplement des tables.",
      competencesAcquises: [
        "Modélisation d'un schéma relationnel (clés primaires / étrangères)",
        "Écriture de scripts SQL de création de tables",
        "Peuplement d'une base depuis un fichier plat",
        "Prise en main d'un AGL (SQL Power Architect)",
      ],
      ...
      resume: "À COMPLÉTER : court résumé de la SAÉ.", todo: true, preuves: [] },
    {
      ...
      resume: "Installation et configuration d'un serveur web sous Linux : Apache, MariaDB et PHP, comptes utilisateurs, base de données et pages personnelles (userdir).",
      objectif: "Mettre en place un environnement serveur fonctionnel sous Linux et configurer les services réseau associés (web et base de données).",
      role: "Réalisée en autonomie : création d'un utilisateur, installation et configuration d'Apache, MariaDB et PHP, création de la base et gestion des droits, mise en service des pages personnelles (mod_userdir) et tests HTML/PHP.",
      competencesAcquises: [
        "Administration Linux en ligne de commande",
        "Installation et configuration d'un serveur web (Apache)",
        "Mise en place d'un SGBD (MariaDB) et gestion des droits",
        "Configuration de PHP et des pages personnelles (userdir)",
      ],
    ...
    },
    {
      ...
      resume: "Exploitation et analyse d'une base de données de réseau social : requêtes SQL et visualisations pour dégager des tendances (corrélation engagement / vues, effet de seuil).",
      ...
      role: "Réalisée en autonomie : requêtes SQL, visualisations et interprétation statistique (corrélation de Pearson ≈ 0,95 entre engagement et vues, mise en évidence d'un effet de seuil).",
      competencesAcquises: [
        "Requêtes SQL d'exploitation",
    ...
    /* ===== BUT2 (à créer au fil de l'année) ===== */
    {
      ...
      mission: "Concevoir une application web multi-rôles (demandeur, éditeur, responsable colis, administrateur) en architecture MVC + couche Service, avec authentification CAS universitaire et déploiement Docker.",
      ...
      role: "J'ai pris en charge la couche données et métier : conception du Modèle Entité-Association (MEA) et du schéma, développement des classes DAO (CommandeDAO, ColisDAO, BonLivraisonDAO, Historique…) avec Adel, de la couche Service, et du lien entre la couche métier et les contrôleurs — soit 33 h, environ 23 % du projet.",
      difficultes: "Les risques majeurs étaient une mauvaise conception de la base de données (qui aurait imposé une refonte totale), l'intégration de l'authentification CAS, la fiabilité des données et la gestion des anomalies (colis sans bon de commande, données incohérentes).",
      solution: "J'ai sécurisé la conception en modélisant rigoureusement le MEA en amont et en structurant des DAO à requêtes préparées (protection contre les injections SQL). L'architecture MVC + couche Service a permis d'isoler les responsabilités et de répartir proprement le travail entre les 5 membres, rendant l'application maintenable malgré la taille de l'équipe.",
      competencesAcquises: [
        "Conception d'un modèle de données relationnel (MEA → schéma MySQL)",
        "Développement de la couche d'accès aux données (DAO) en Python",
        "Architecture MVC + couche Service (séparation des responsabilités)",
        "Travail collaboratif à 5 avec Git/GitHub et suivi de projet",
      ...
      apres: "Capable de concevoir un modèle relationnel, d'implémenter une couche DAO/Service sécurisée et de m'intégrer dans une architecture MVC partagée à plusieurs.",
      niveaux: [
        { comp: "Réaliser", but1: 55, but2: 80 },
        { comp: "Gérer les données", but1: 50, but2: 78 },
        { comp: "Collaborer", but1: 70, but2: 86 },
      ],
      perspectives: "Il me reste à renforcer les tests automatisés sur la couche DAO/Service et à approfondir le déploiement (Docker, CI/CD) au-delà du local, ainsi que des fonctionnalités avancées comme l'OCR des étiquettes.",
      preuves: [
    ...
    { id: "s3-04", code: "SAÉ S3.04", important: false, titre: "Bases de données avancées",
      ...
      resume: "À COMPLÉTER : court résumé de la SAÉ BUT2.", todo: true, preuves: [] },
  ],
  ...
  stage: {
    ...
    missions: [
      "Projet principal — Mercator (cartographie du SI) : j'ai installé de zéro cet outil open-source sur un serveur virtuel dédié (CRT01, en SSH via PuTTY/SFTP), puis développé les scripts qui l'alimentent automatiquement avec les données réelles de l'entreprise (machines virtuelles, serveurs physiques, bases de données, applications IIS, sauvegardes Veeam).",
      "Mon apport clé sur Mercator : face à l'incompatibilité entre mes scripts Python et VTOM (l'ordonnanceur de l'entreprise, qui ne pilote que PowerShell), j'ai conçu une API Flask exposant ma logique Python en HTTP — la solution qui a débloqué le projet — puis automatisé la collecte directement depuis l'Active Directory, supprimant toute saisie manuelle.",
      "Projet SPN : j'ai automatisé la gestion des Service Principal Names dans l'Active Directory via deux scripts PowerShell (SPN-Audit-Auto.ps1 et SPN-Cleanup.ps1) mis en production dans le planificateur de tâches. Résultat concret : vérification passée de 2 h/mois manuelles à 5 min/jour automatisées, et taux de correction porté d'environ 60 % à près de 100 %.",
      "Réseau : mise en place de switches de A à Z (câblage, drivers, configuration en ligne de commande via PuTTY/Extreme), création volontaire d'une boucle réseau pour en observer les effets (tempête de broadcast), puis mise en place du protocole Spanning Tree.",
      "Exploitation & support : masterisation de postes (MECM, découverte d'Autopilot), gestion des expéditions de matériel vers les agences (tickets RITM, Chronopost) et résolution d'incidents utilisateurs via ServiceNow (diagnostic matériel, remplacement d'écrans, relation avec des utilisateurs non techniques).",
      "Immersion en équipe développement : apprentissage du C# (Microsoft Learn) et premiers tests sur le portail DSI (back-end C#, front-end Angular, Azure DevOps, API REST / Swagger).",
    ],
    decouvertes: [
      "Tout un écosystème d'outils professionnels : ServiceNow (gestion des tickets & traçabilité), Zabbix (supervision réseau), Veeam/VMware (sauvegarde & virtualisation), VTOM (ordonnancement), MECM/Autopilot (déploiement de postes), Active Directory & Kerberos.",
      "GenIA, l'IA interne d'ICF Habitat — basée sur ChatGPT mais confinée au système d'information pour garantir la confidentialité des données : une découverte en lien direct avec mon appétence pour l'IA.",
      "La réalité physique de l'infrastructure (visite de la salle serveur : baies, switches, stockage) et la coexistence de technologies historiques (AS400) avec des outils très modernes.",
    ],
    ...
    metier: "J'ai découvert le métier d'administrateur système & réseau / exploitation, et il m'a beaucoup plu : un métier où la technicité se mêle à la réflexion et où l'imprévu fait partie du quotidien. Ce stage a confirmé mon intérêt pour ce domaine, tout en m'ouvrant d'autres horizons — le développement applicatif (C#/Angular) et surtout l'IA appliquée à l'entreprise (GenIA), qui rejoint mon projet professionnel.",

    // 2 compétences du BUT mises en avant grâce au stage
    competencesStage: [
      { id: "administrer", commentaire: "Cœur du stage : installation et administration de serveurs (PuTTY/SFTP), Active Directory, supervision (Zabbix), configuration de switches et Spanning Tree, déploiement de postes — une vraie montée en compétence sur l'exploitation d'un SI à l'échelle de 1 500 collaborateurs." },
      { id: "realiser", commentaire: "J'ai développé de vrais outils : scripts d'importation Python, API REST avec Flask, scripts d'automatisation PowerShell (projet SPN) et premiers pas en C#/Angular — du développement concret, en conditions de production." },
    ],

    objectifs: {
      court: "Confirmer mon orientation vers l'administration système & réseau et décrocher une alternance de qualité pour la fin du BUT, dans un environnement aussi formateur que celui que j'ai connu chez ICF Habitat.",
      moyen: "Après le BUT, intégrer une école d'ingénieur ou un master orienté IA / data science, en gardant le lien avec l'infrastructure et les systèmes que j'ai appris à administrer.",
      long: "Devenir ingénieur en informatique dans l'IA ou la santé, sur des projets à impact concret (aide au diagnostic, systèmes intelligents), en m'appuyant sur la double culture développement + infrastructure acquise pendant ce stage.",
    },
  },
  ...
  -------------------------------------------------------------------------- */
  rapportEtonnement: [
    { titre: "La confiance accordée", texte: "J'ai été surpris de l'autonomie confiée à un stagiaire : sur un projet d'envergure comme Mercator, on me présentait le besoin global puis on me laissait définir ma propre approche technique. Cette confiance m'a poussé à structurer ma démarche et à assumer mes choix." },
    { titre: "La technique ne suffit pas", texte: "Je pensais qu'un bon niveau technique suffisait. J'ai découvert que la rigueur de la traçabilité (tout documenter dans ServiceNow), la communication quotidienne (morning routine) et le partage de savoir comptent tout autant que la maîtrise d'un outil." },
    { titre: "Une IA d'entreprise confidentielle", texte: "Découvrir GenIA, une IA interne de type ChatGPT mais confinée au système d'information pour protéger les données sensibles, m'a marqué : c'est exactement le genre d'usage responsable de l'IA qui rejoint mon projet professionnel." },
    { titre: "Entre héritage et modernité", texte: "J'imaginais une grande DSI 100 % à la pointe. En réalité, des technologies historiques comme l'AS400 (IBM) cohabitent avec des approches très modernes comme Autopilot (cloud) : un système d'information d'entreprise se construit dans la durée." },
  ],

  /* ------------------------------------------------------------------ CONTACT */
  contact: {
    intro: "Curieux, autonome et persévérant — je recherche une alternance pour la fin de mon BUT. N'hésitez pas à me contacter.",
    liens: [
